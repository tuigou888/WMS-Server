...
import com.wms.common.ApiResponse; import com.wms.dto.*; import com.wms.service.DocumentService; import jakarta.validation.Valid; import org.springframework.web.bind.annotation.*; import java.util.*;
@RestController @RequestMapping public class DocumentController {
 ...
 @PostMapping("/stocktakes/{id}/review") public ApiResponse<Map<String,Object>> reviewStocktake(@PathVariable Long id,@Valid @RequestBody ReviewRequest r){return ApiResponse.ok("审核完成",service.reviewStocktake(id,r));}
