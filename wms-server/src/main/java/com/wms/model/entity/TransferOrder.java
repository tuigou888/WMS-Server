...
@Entity @Table(name="transfer_orders") public class TransferOrder extends AuditableEntity {
 ...
 public Long getId(){return id;} public String getTransferNo(){return transferNo;} public void setTransferNo(String v){transferNo=v;} public String getStatus(){return status;} public void setStatus(String v){status=DocumentStateMachine.transition(status,v);}
