...
@Entity @Table(name="stocktake_orders") public class StocktakeOrder extends AuditableEntity {
 ...
 public Long getId(){return id;} public String getStocktakeNo(){return stocktakeNo;} public void setStocktakeNo(String v){stocktakeNo=v;} public String getStatus(){return status;} public void setStatus(String v){status=DocumentStateMachine.transition(status,v);}
