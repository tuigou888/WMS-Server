...
@Entity @Table(name="stocktake_lines") public class StocktakeLine extends AuditableEntity {
 ...
 @Column(nullable=false) private String locationCode; @Column(length=60) private String batchNo; @Column(nullable=false,precision=18,scale=4) private BigDecimal bookQuantity; @Column(precision=18,scale=4) private BigDecimal actualQuantity; @Column(precision=18,scale=4) private BigDecimal differenceQuantity; @Column(name="snapshot_version",nullable=false) private long snapshotVersion;
 ...
 public long getSnapshotVersion(){return snapshotVersion;} public void setSnapshotVersion(long v){snapshotVersion=v;}
}
