...
const routes = [
  { path: '/login', name: 'login', component: () => import('../pages/LoginPage.vue'), meta: { title: '登录' } },
  {
    ...
    children: [
      ...
      { path: 'stock-in', name: 'stock-in', component: () => import('../pages/MovementPage.vue'), props: { type: 'in' }, meta: { title: '扫码入库', perm: 'inventory:scan' } },
      { path: 'stock-out', name: 'stock-out', component: () => import('../pages/MovementPage.vue'), props: { type: 'out' }, meta: { title: '扫码出库', perm: 'inventory:scan' } },
      ...
      { path: 'tools', name: 'tools', component: () => import('../pages/ToolsPage.vue'), meta: { title: '二维码与电子表格', perm: 'qrcode:read' } },
